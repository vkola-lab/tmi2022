...
python build_graphs.py --weights "model.pth" --dataset "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/TCGA_LUNG/tiles/" --output "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/TCGA_LUNG/graphs"
