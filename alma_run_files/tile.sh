...
python src/tile_WSI.py -s 512 -e 0 -j 12 -B 50 -M 20 -o  /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/TCGA_LUNG/tiles/ "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/TCGA_data/TCGA_flat/*.svs"
