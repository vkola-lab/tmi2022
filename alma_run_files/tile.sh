...
python src/tile_WSI.py -s 512 -e 0 -j 32 -B 50 -M 20 -s 256 -o  /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/cam_16/ "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/camelyon_data/camelyon_slides/slides/*.tif"
