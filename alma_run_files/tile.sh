...
python src/tile_WSI.py -s 512 -e 0 -j 32 -B 50 -M 1 -o  /data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/tmi/cam-16/tiles/ "/data/scratch/DBI/DUDBI/DYNCESYS/OlgaF/camelyon_data/camelyon_slides/slides/*.tif"
